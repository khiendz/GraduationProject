...
import { StorageService, StorageKey } from 'src/app/shared/services/storage.service';
...
export class DeviceSelectComponent implements OnInit {
  ...
  onSettingsChanged(deviceId: any) {
      this.setAndEmitSelections(this.key, this.selectedId = deviceId.value);
  }
